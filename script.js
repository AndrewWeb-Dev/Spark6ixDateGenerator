...
$(function() {
		...
		artsy : [
			{
				...
				image: "http://blogs-images.forbes.com/insertcoin/files/2016/07/pokemon-go-new3-1200x675.jpg",
			...
			},
			{
				...
				image: "http://www.citynews.ca/wp-content/blogs.dir/sites/10/2014/11/brain-exhibit.jpg",
			...
			},
			{
				...
				image: "https://www.agakhanmuseum.org/sites/default/files/uploaded/AKM_f1_1246x620.jpg",
			...
			},
			{
				...
				image: "http://cineplexfiles.s3.amazonaws.com/Theatres/GroupSales/CorporateScreenings/Gallery/vip_4.jpg",
			...
			},
			{
				...
				image: "http://pulpartparty.ca/wp-content/uploads/2013/07/5.jpg",
			...
			},
			{
				...
				image: "http://fleetwayfun.com/wp-content/uploads/2015/06/playdium-london-ontario-fleetway-fun.jpg",
			...
			},
			{
				...
				image: "http://torontoist.com/wp-content/uploads/2013/10/20131016-Ripleys-Aquarium-of-Canada-Opening-2154-Photo_by_Corbin_Smith.jpg",
			...
			},
			{
				...
				image:"http://www.offcentredj.com/uploads/2/3/0/0/230091/3569129_orig.jpg",
			...
			},
			{
				...
				image: "https://assets.entrepreneur.com/content/3x2/1300/1412792444-walking-dead-thrives-zombie-survival-camps.jpg",
			...
			},
			{
				...
				image: "../Fiona_Drew_Jackie_Week4/images/Nerdy/secondCity.jpg",
			...
			},
			{
				...
				image: "https://national.ballet.ca/NBOC/media/MediaLibrary/Images/Productions/Winters-Tale/WintersTale_Gallery01.jpg?width=1000&height=686&ext=.jpg",
			...
			},
			{
				...
				image: "http://www.newsonair.org/images/high-quality-boston-paint-night-2-paint-nite-boston-730-x-410.jpg",
	...
	//create a list of pick up lines
		...
		$(".pickUpLine").html(`<h2>Need a date? Try saying this:</h2><h3>${randomPickUpLine}</h3>`);
